            ...
            return function(params, value) {
              ...
              try {
                ...
                if (params.ttl != null) {
                  ...
                  if ((_this.cacheTTL.flex != null) && (params.ttl < _this.cacheTTL.flex)) {
    ...
    Client.prototype._riotRequestWithCache = function(params, cacheParams, options) {
      ...
      return this.cache.get(cacheParams).then((function(_this) {
        return function(cachedAnswer) {
          var answer, cacheTime, value, _ref;
          _ref = cachedAnswer != null ? cachedAnswer : {}, value = _ref.value, cacheTime = _ref.cacheTime;
          if ((cachedAnswer == null) || (((cachedAnswer != null ? cachedAnswer.expires : void 0) != null) && cachedAnswer.expires < Date.now())) {
